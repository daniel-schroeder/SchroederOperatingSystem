...
//
const APP_NAME: string    = "DSOS";   // 'cause Bob and I were at a loss for a better name.
...
//
var _CPU: DSOS.Cpu;  // Utilize TypeScript's type annotation system to ensure that _CPU is an instance of the Cpu class.
...
// UI
var _Console: DSOS.Console;
var _OsShell: DSOS.Shell;
